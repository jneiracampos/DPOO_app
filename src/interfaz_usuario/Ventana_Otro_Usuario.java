...
public class Ventana_Otro_Usuario extends JFrame implements ActionListener {
	...
	public Ventana_Otro_Usuario(Ventana_Opciones padre) {
	...
	private void addPanelNorte() {
		...
		JLabel txt = new JLabel("Otro Usuario: ");
		panelNorte.add(txt);
	...
	private void addPanel1() {
		...
		JLabel descProyecto = new JLabel("Correo:");
